        ...
        onItemSelect: function (oEvent) {
            ...
            switch (oFragmentKey) {
              ...
              case "demo14":
                ...
                this.oModel.oData.echartOption[13].series[0].nodes = nodes;
                this.oModel.oData.echartOption[13].series[0].edges = edges;
                this.showChart(this.Page14Id,this.oModel.oData.echartOption[13]);
                break;                                                
            }
          },
          createNodes:function(widthCount, heightCount) {
            var nodes = [];
          ...
          createEdges:function(widthCount, heightCount) {
            var edges = [];
            for (var i = 0; i < widthCount; i++) {
              for (var j = 0; j < heightCount; j++) {
                if (i < widthCount - 1) {
